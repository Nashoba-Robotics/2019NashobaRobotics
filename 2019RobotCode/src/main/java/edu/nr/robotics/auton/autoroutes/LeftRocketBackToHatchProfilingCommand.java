...
public class LeftRocketBackToHatchProfilingCommand extends CommandGroup {
    ...
    public LeftRocketBackToHatchProfilingCommand() {
        addSequential(new EnableTwoDMotionProfile(Distance.ZERO, Distance.ZERO, Angle.ZERO, Drive.PROFILE_DRIVE_PERCENT, Drive.ACCEL_PERCENT, "LeftRocketBackToHatch"));
    }
