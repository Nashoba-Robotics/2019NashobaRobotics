...
public class StartPosLeftToCargoShipSideProfilingCommand extends CommandGroup{
    ...
    public StartPosLeftToCargoShipSideProfilingCommand() {
        addSequential(new EnableTwoDMotionProfile(Distance.ZERO, Distance.ZERO, Angle.ZERO, Drive.PROFILE_DRIVE_PERCENT, Drive.ACCEL_PERCENT, "StartPosLeftToCargoShipSide"));
