...
public class HatchRightToRocketFrontProfilingCommand extends CommandGroup {
    ...
    public HatchRightToRocketFrontProfilingCommand() {
       addSequential(new EnableTwoDMotionProfile(Distance.ZERO, Distance.ZERO, Angle.ZERO, Drive.PROFILE_DRIVE_PERCENT, Drive.ACCEL_PERCENT, "HatchRightToRocketFront"));
    }
