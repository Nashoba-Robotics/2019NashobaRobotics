...
public class LeftRocketFrontToCargoProfilingCommand extends CommandGroup{
    ...
    public LeftRocketFrontToCargoProfilingCommand() {
        addSequential(new EnableTwoDMotionProfile(Distance.ZERO, Distance.ZERO, Angle.ZERO, Drive.PROFILE_DRIVE_PERCENT, Drive.accelPercent, "LeftRocketFrontToCargo"));
    }
