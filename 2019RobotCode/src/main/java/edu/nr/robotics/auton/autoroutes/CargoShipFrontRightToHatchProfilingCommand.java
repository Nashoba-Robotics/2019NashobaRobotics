...
public class CargoShipFrontRightToHatchProfilingCommand extends CommandGroup {
    ...
    public CargoShipFrontRightToHatchProfilingCommand() {
        ...
        addSequential(new EnableMotionProfile(new Distance(-24, Distance.Unit.INCH), Distance.ZERO, Drive.ONE_D_PROFILE_DRIVE_PERCENT, Drive.ONE_D_ACCEL_PERCENT));
        ...
        addSequential(new EnableMotionProfile(new Distance(46, Distance.Unit.INCH), Distance.ZERO, Drive.ONE_D_PROFILE_DRIVE_PERCENT, Drive.ONE_D_ACCEL_PERCENT));
