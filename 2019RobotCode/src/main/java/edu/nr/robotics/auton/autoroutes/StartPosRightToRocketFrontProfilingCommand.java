...
public class StartPosRightToRocketFrontProfilingCommand extends CommandGroup{
    public StartPosRightToRocketFrontProfilingCommand(){
        addSequential(new EnableTwoDMotionProfile(Distance.ZERO, Distance.ZERO, Angle.ZERO, Drive.PROFILE_DRIVE_PERCENT, Drive.ACCEL_PERCENT, "StartPosRightToRocketFront"));
    }
}
