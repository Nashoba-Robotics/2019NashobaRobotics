...
public class LeftRocketBackToCargoProfilingCommand extends CommandGroup {
    ...
    public LeftRocketBackToCargoProfilingCommand() {
       addSequential(new EnableTwoDMotionProfile(Distance.ZERO, Distance.ZERO, Angle.ZERO, Drive.PROFILE_DRIVE_PERCENT, Drive.ACCEL_PERCENT, "LeftRocketBackToCargo"));
    }
