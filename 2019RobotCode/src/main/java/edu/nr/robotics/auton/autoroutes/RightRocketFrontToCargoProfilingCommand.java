...
public class RightRocketFrontToCargoProfilingCommand extends CommandGroup{
    ...
    public RightRocketFrontToCargoProfilingCommand() {
        addSequential(new EnableTwoDMotionProfile(Distance.ZERO, Distance.ZERO, Angle.ZERO, Drive.PROFILE_DRIVE_PERCENT, Drive.ACCEL_PERCENT, "RightRocketFrontToCargo"));
    }
