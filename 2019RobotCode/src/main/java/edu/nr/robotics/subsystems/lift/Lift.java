...
public class Lift extends NRSubsystem {
    ...
    private void smartDashboardInit() {
        if (EnabledSubsystems.ELEVATOR_SMARTDASHBOARD_DEBUG_ENABLED) {
            ...
            SmartDashboard.putNumber("F Vel Lift Back: ", F_VEL_LIFT_BACK);
