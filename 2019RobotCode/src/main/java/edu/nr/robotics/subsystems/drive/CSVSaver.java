				...
				public void run() {
					while(true) {
						while (enabled) {
							...
							out.print(",");
							out.print(Drive.getInstance().getLeftVelocity().get(Distance.Unit.METER, Time.Unit.SECOND));
							out.print(",");
							out.print(Drive.getInstance().getRightVelocity().get(Distance.Unit.METER, Time.Unit.SECOND));
							out.print('\n');
							out.flush();
