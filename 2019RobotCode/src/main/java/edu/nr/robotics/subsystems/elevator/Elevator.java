...
public class Elevator extends NRSubsystem implements PIDOutput, PIDSource {
    ...
    public static final Distance HATCH_PLACE_TOP_HEIGHT_ELEVATOR = new Distance(72.5, Distance.Unit.INCH).sub(GROUND_TO_HATCH_MANIPULATOR_NEUTRAL_HEIGHT); //72.5
    ...
    public static final Distance CLIMB_END_DISTANCE = new Distance(4.5,  Distance.Unit.INCH);

    public static final double CLIMB_CURRENT_SPIKE = 0.9;
