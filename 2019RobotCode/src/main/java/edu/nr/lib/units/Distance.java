...
public class Distance {
	...
	public enum Unit implements GenericUnit {
		 ...
		 * For the Aux Drive
		 */
		private static final double ENCODER_TICK_AUX_DRIVE_PER_INCH = AuxiliaryDrive.EFFECTIVE_ENC_TICK_PER_INCH_AUX_DRIVE;
		...
		public double convertToDefault(double val) {
			...
			if(this == Unit.MAGNETIC_ENCODER_TICK_AUX_DRIVE) {
				return val / ENCODER_TICK_AUX_DRIVE_PER_INCH;
			}
			return 0;
		}
		...
		public double convertFromDefault(double val) {
			...
			if(this == Unit.MAGNETIC_ENCODER_TICK_AUX_DRIVE) {
				return ENCODER_TICK_AUX_DRIVE_PER_INCH * val;
			}
			return 0;
		}
}
